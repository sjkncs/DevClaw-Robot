...
public:
    ...
    // Phase 2: Kalman Filter state estimator (replaces IIR velocity estimate)
    JointKalmanFilter kalmanFilter;
    bool useKalmanFilter = true;  // Toggle between KF and legacy IIR

    void SetUseKalmanFilter(bool _use) { useKalmanFilter = _use; }
